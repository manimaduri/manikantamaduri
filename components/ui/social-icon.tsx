import { Mail, AtSign, Phone, type LucideIcon } from "lucide-react";
import type { SocialLink } from "@/content/data/types";

/**
 * Brand icons (GitHub, LinkedIn) were removed from lucide-react, so they're
 * rendered as inline SVG glyphs. Non-brand icons use lucide.
 */
const LUCIDE: Partial<Record<SocialLink["icon"], LucideIcon>> = {
  mail: Mail,
  phone: Phone,
  twitter: AtSign,
};
